(function () {
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["styles"], {
    ...
    function I9Y(module, __webpack_exports__, __webpack_require__) {
      ...
      ___CSS_LOADER_EXPORT___.push([module.i, "@import url(https://fonts.googleapis.com/css2?family=PT+Sans&display=swap);"]); // Module


      ___CSS_LOADER_EXPORT___.push([module.i, "* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  font-family: \"PT Sans\", sans-serif;\n}\nsection {\n  padding: 60px 0;\n}\nh2 {\n  text-align: center;\n  font-size: 25px;\n}\n.content {\n  width: 1200px;\n  margin: 0 auto;\n}\n.mc-text {\n  color: #F28066;\n}\n.button {\n  font-size: 20px;\n  border: none;\n  border-radius: 50px;\n  padding: 10px 15px;\n  background-color: #F28066;\n  color: white;\n  outline: 0;\n  box-shadow: 0px 2px 6px #F28066;\n  cursor: pointer;\n}\n.button:hover {\n  box-shadow: 0px 0px 6px #F28066;\n  background-color: #fff;\n  color: #F28066;\n  font-weight: bold;\n}\n.darksection {\n  background-color: #F2EDE4;\n}\n@media (max-width: 1200px) {\n  .content {\n    padding: 0 20px;\n    width: 100%;\n  }\n}", "", {
        "version": 3,
        "sources": ["webpack://src/styles.scss"],
        "names": [],
        "mappings": "AAMA;EACI,SAAA;EACA,UAAA;EACA,sBAAA;EACA,kCAAA;AAJJ;AAMA;EACI,eAAA;AAHJ;AAKA;EACI,kBAAA;EACA,eAAA;AAFJ;AAIA;EACI,aAAA;EACA,cAAA;AADJ;AAGA;EACI,cAtBC;AAsBL;AAEA;EACI,eAAA;EACA,YAAA;EACA,mBAAA;EACA,kBAAA;EACA,yBA7BC;EA8BD,YAAA;EACA,UAAA;EACA,+BAAA;EACA,eAAA;AACJ;AAAI;EACI,+BAAA;EACA,sBAAA;EACA,cArCH;EAsCG,iBAAA;AAER;AACA;EACI,yBAxCE;AA0CN;AACA;EACI;IACI,eAAA;IACA,WAAA;EAEN;AACF",
        "sourcesContent": ["@import url('https://fonts.googleapis.com/css2?family=PT+Sans&display=swap');\n\n$mc: #F28066;\n$cc: #025E73;\n$bgc: #F2EDE4;\n\n* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    font-family: 'PT Sans', sans-serif;\n}\nsection {\n    padding: 60px 0;\n}\nh2 {\n    text-align: center;\n    font-size: 25px;\n}\n.content {\n    width: 1200px;\n    margin: 0 auto;\n}\n.mc-text {\n    color: $mc;\n}\n.button {\n    font-size: 20px;\n    border: none;\n    border-radius: 50px;\n    padding: 10px 15px;\n    background-color: $mc;\n    color: white;\n    outline: 0;\n    box-shadow: 0px 2px 6px $mc;\n    cursor: pointer;\n    &:hover {\n        box-shadow: 0px 0px 6px $mc;\n        background-color: #fff;\n        color: $mc;\n        font-weight: bold;\n    }\n}\n.darksection {\n    background-color: $bgc;\n}\n\n@media (max-width: 1200px) {\n    .content {\n        padding: 0 20px;\n        width: 100%;\n    }\n}"],
        "sourceRoot": ""
      }]); // Exports
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! D:\free\dezibd\dez\src\styles.scss */
      "+EN/");
      /***/
    },
